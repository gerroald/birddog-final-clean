 ...
 */
$saaslauncher_images = trailingslashit(get_template_directory_uri());
$saaslauncher_images = array(
    $saaslauncher_images . 'assets/images/star.png',
    $saaslauncher_images . 'assets/images/play_icon.png',
    $saaslauncher_images . 'assets/images/launcher-dash.png',
);
?>
<!-- wp:group {"metadata":{"categories":["saaslauncher-hero"],"patternName":"cozy-essential-addons/saaslauncher-hero-with-popup","name":"PRO: Hero Section with Video Popup"},"align":"full","style":{"spacing":{"blockGap":"0","margin":{"top":"0","bottom":"0"},"padding":{"right":"0","left":"0","top":"0","bottom":"0"}}},"gradient":"center-gradient","layout":{"type":"constrained","contentSize":"1180px"}} -->
    ...
    <div class="wp-block-cover is-light" style="margin-top:0px;padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40);min-height:640px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span>
        <div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
            <div class="wp-block-group"><!-- wp:group {"className":"is-style-saaslauncher-animated-border","style":{"spacing":{"padding":{"top":"1px","bottom":"1px","left":"12px","right":"12px"}},"border":{"radius":"60px","width":"1px"}},"backgroundColor":"dark-shade","layout":{"type":"constrained"}} -->
                <div class="wp-block-group is-style-saaslauncher-animated-border has-dark-shade-background-color has-background" style="border-width:1px;border-radius:60px;padding-top:1px;padding-right:12px;padding-bottom:1px;padding-left:12px"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20","margin":{"top":"0","bottom":"0"}}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
                    <div class="wp-block-group" style="margin-top:0;margin-bottom:0"><!-- wp:image {"id":1859,"width":"20px","height":"20px","scale":"contain","sizeSlug":"full","linkDestination":"none","style":{"spacing":{"margin":{"top":"0","bottom":"3px","left":"0","right":"0"}}}} -->
                        <figure class="wp-block-image size-full is-resized" style="margin-top:0;margin-right:0;margin-bottom:3px;margin-left:0"><img src="<?php echo esc_url($saaslauncher_images[0]) ?>" alt="" class="wp-image-1859" style="object-fit:contain;width:20px;height:20px" /></figure>
                        <!-- /wp:image -->

                        <!-- wp:heading {"level":5,"style":{"elements":{"link":{"color":{"text":"var:preset|color|light-color"}}}},"textColor":"light-color","fontSize":"x-small"} -->
                        <h5 class="wp-block-heading has-light-color-color has-text-color has-link-color has-x-small-font-size"><?php esc_html_e('4.9 Ratings based on 1,000+ reviews', 'cozy-essential-addons') ?></h5>
                        <!-- /wp:heading -->
                    </div>
                    <!-- /wp:group -->
                </div>
            ...
            <div class="wp-block-group" style="margin-top:20px;margin-bottom:0"><!-- wp:heading {"textAlign":"center","level":1,"className":"saaslauncher-big-title","style":{"typography":{"fontStyle":"normal","fontWeight":"600","fontSize":"84px","lineHeight":"1.3"},"elements":{"link":{"color":{"text":"var:preset|color|light-color"}}}},"textColor":"light-color"} -->
                <h1 class="wp-block-heading has-text-align-center saaslauncher-big-title has-light-color-color has-text-color has-link-color" style="font-size:84px;font-style:normal;font-weight:600;line-height:1.3"><?php esc_html_e('Build Quickly. Grow Rapidly. No Coding Required', 'cozy-essential-addons') ?></h1>
                <!-- /wp:heading -->
            ...
            <div class="wp-block-group wp-embed-aspect-4-3 wp-has-aspect-ratio" style="margin-top:28px;margin-bottom:0"><!-- wp:buttons {"className":"is-style-button-zoom-on-hover","style":{"spacing":{"margin":{"top":"0px"}}},"layout":{"type":"flex","justifyContent":"center"}} -->
                <div class="wp-block-buttons is-style-button-zoom-on-hover" style="margin-top:0px"><!-- wp:button {"className":"is-style-button-with-shadow-style-one","style":{"border":{"radius":"60px"},"spacing":{"padding":{"left":"32px","right":"32px","top":"18px","bottom":"18px"}}},"fontSize":"medium"} -->
                    <div class="wp-block-button is-style-button-with-shadow-style-one"><a class="wp-block-button__link has-medium-font-size has-custom-font-size wp-element-button" style="border-radius:60px;padding-top:18px;padding-right:32px;padding-bottom:18px;padding-left:32px"><?php esc_html_e('Start Free Trial', 'cozy-essential-addons') ?></a></div>
                    <!-- /wp:button -->
                </div>
                <!-- /wp:buttons -->

                <!-- wp:cozy-block/modal {"blockClientId":"a845e277-5703-4c3e-ac7e-7bd85ea34e1d","boxWidth":780,"modalEvent":"click","backgroundOverlayColor":"#0a0a0ad1","backgroundColor":"#0A0A0A","iconStyles":{"enabled":true,"alignment":"right","horizontalSpacing":20,"verticalSpacing":50,"boxWidth":40,"boxHeight":40,"radius":100,"iconSize":10,"bg":"#AC5BFF","bgHover":"#6967FF","iconColor":"#FFFFFE","iconColorHover":"","border":"1px solid #000","borderRadius":20},"clickButtonStyles":{"padding":{"top":10,"right":10,"bottom":10,"left":10},"content":"image","label":"Open Popup","imgURL":"<?php echo esc_url($saaslauncher_images[1]) ?>","imgWidth":68,"imgHeight":68,"imgRadius":0,"imgHasPulse":true,"fontSize":14,"justify":"center","borderType":"none","borderWidth":{"top":1,"right":1,"bottom":1,"left":1},"borderColor":"#000","borderRadius":60,"color":"#ffffff00","colorHover":"","bgColor":"#ffffff00","bgColorHover":""}} -->
                <a class="cozy-modal-open" data-type="a845e277-5703-4c3e-ac7e-7bd85ea34e1d">
                    <figure class="cozy-modal-open__img has-pulse-animation"><img src="<?php echo esc_url($saaslauncher_images[1]) ?>" /></figure>
                </a>
                <div class="cozy-block-modal  type-default event-click display-none icon-align-right" id="cozyBlock_a845e277_5703_4c3e_ac7e_7bd85ea34e1d">
                    ...
                    <div class="wp-block-group" style="padding-top:50px;padding-right:16px;padding-bottom:50px;padding-left:16px"><!-- wp:embed {"url":"https://www.youtube.com/watch?v=DeL7EeEkzMc","type":"video","providerNameSlug":"youtube","responsive":true,"className":"wp-embed-aspect-4-3 wp-has-aspect-ratio"} -->
            ...
            <div class="wp-block-group" style="margin-top:64px"><!-- wp:group {"className":"is-style-saaslauncher-overflow-hidden","style":{"border":{"radius":"20px","width":"1px"},"spacing":{"padding":{"right":"var:preset|spacing|40","left":"var:preset|spacing|40","top":"0","bottom":"0"}}},"backgroundColor":"dark-shade","borderColor":"primary","layout":{"type":"constrained","contentSize":"1180px"}} -->
                <div class="wp-block-group is-style-saaslauncher-overflow-hidden has-border-color has-primary-border-color has-dark-shade-background-color has-background" style="border-width:1px;border-radius:20px;padding-top:0;padding-right:var(--wp--preset--spacing--40);padding-bottom:0;padding-left:var(--wp--preset--spacing--40)"><!-- wp:image {"id":282,"sizeSlug":"full","linkDestination":"none","align":"full","className":"is-style-saaslauncher-image-hover-zoom","style":{"border":{"radius":"20px"}}} -->
                    <figure class="wp-block-image alignfull size-full has-custom-border is-style-saaslauncher-image-hover-zoom"><img src="<?php echo esc_url($saaslauncher_images[2]) ?>" alt="" class="wp-image-282" style="border-radius:20px" /></figure>
                    <!-- /wp:image -->
                </div>
                <!-- /wp:group -->
            </div>
