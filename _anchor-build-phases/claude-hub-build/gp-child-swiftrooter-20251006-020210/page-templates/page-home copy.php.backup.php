...
<!--<header class="header">
  <div class="wrap bar">
    ...
    <nav style="display:flex;gap:18px">
      ...
      <a href="#quote" class="btn btn--primary" style="padding:8px 14px">Get Quote</a>
    </nav>
  </div>
</header>-->
    ...
    <div class="hero-grid">
      <div>
        ...
        <div class="hero-actions">
          <a class="btn btn--primary" href="#quote">Get Free Estimate — Save $50</a>
      ...
      <aside class="form" id="quote" aria-label="Get Your Free Moving Quote">
        <h3>Get Your Free Moving Quote</h3>
        <form>
          <div class="row">
            <label><span class="lbl">From ZIP</span><input type="text" placeholder="73101" required></label>
            <label><span class="lbl">To ZIP</span><input type="text" placeholder="73102" required></label>
          </div>
          <div class="row">
            <label><span class="lbl">Move Type</span>
              <select required>
            ...
            <label><span class="lbl">Property Size</span>
              <select required>
          ...
          <div class="row">
            <label><span class="lbl">Email</span><input type="email" placeholder="you@email.com" required></label>
            <label><span class="lbl">Phone</span><input type="tel" placeholder="(405) 555-0123" required></label>
          </div>
          <button class="btn btn--primary" type="submit" style="width:100%;margin-top:10px">Get My Free Estimate Now</button>
          <p style="text-align:center;margin:8px 0 0;color:var(--muted)">Response within 2 hours • No obligation</p>
        </form>
      </aside>
    </div>
  </div>
  ...
  <div class="l-container">
   ...
   <!-- <div class="hero__content">
      <div class="hero__text">
        ...
        <div class="btn-row">
          <a class="c-button c-button--primary" href="#quote">Get Your Estimate</a>
...
<section id="services" class="services-preview section">
  <div class="l-container">
    <header class="section__header">
      ...
      <p>Residential moves, office relocations, and same-day delivery.</p>
    </header>
    ...
    <div class="services-preview__grid">
      <article class="services-preview__card c-card">
        ...
        <div class="card__body">
          ...
          <p>Homes &amp; apartments with packing, careful transport, and setup.</p>
      ...
      <article class="services-preview__card c-card">
        ...
        <div class="card__body">
          ...
          <p>Minimize downtime. Weekend moves, IT handling, complete setup.</p>
          <a class="c-button c-button--ghost" href="#">View Services</a>
        </div>
      </article>
      ...
      <article class="services-preview__card c-card">
        ...
        <div class="card__body">
          ...
          <p>Same-day delivery for furniture, appliances, and single items.</p>
          <a class="c-button c-button--ghost" href="#">View Services</a>
        </div>
      </article>
    </div>
...
<section id="testimonials" class="testimonials section">
  <div class="l-container">
    ...
    <div class="testimonials__grid">
      <article class="c-card quote"><p>“Absolutely flawless. Early, fast, careful with antiques.”</p><strong>Ashley P. • Edmond</strong></article>
      <article class="c-card quote"><p>“Moved our dental office over a weekend with zero downtime.”</p><strong>Dr. Mark R. • Downtown</strong></article>
      <article class="c-card quote"><p>“Transparent pricing. Delivered exactly what they promised.”</p><strong>Jenna S. • Norman</strong></article>
    </div>
  </div>
</section>
...
<!--<section class="final-cta section">
  <div class="l-container">
    ...
    <div class="btn-row ta-center">
      <a class="c-button c-button--primary" href="#quote">Get Free Estimate</a>
      <a class="c-button c-button--ghost" href="tel:+14055354554">Call (405) 535-4554</a>
    </div>
  </div>
</section>
...
<section class="testimonials-teaser l-section">
    <div class="l-container">
